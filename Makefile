##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.29.1] date: [Mon Dec 10 16:10:19 MSK 2018] 
##########################################################################################################################
...
Drivers/nlib/print.c \
Drivers/nlib/debug.c \
Drivers/nlib/gpio.c \
Drivers/nlib/timer.c \
...
# binaries
#######################################
GCC_PATH = /home/nikita/software/gcc-arm-none-eabi-7-2018-q2-update/bin
...
#######################################
# link script
LDSCRIPT = STM32F205VGTx_FLASH.ld
...
flash_reset: $(FLASH_TARGET)
	...
	-c "program $(FLASH_TARGET) verify 0x8000000" \
	-c "reset run" \
	-c "exit" 
...
.PHONY: all clean flash flash_reset
